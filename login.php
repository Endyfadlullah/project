	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(login/images/959196.png);">
				...
				<form class="login100-form validate-form" action="proses-login.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input class="input100" type="password" name="pass" id="exampleInputPassword" placeholder="Enter password">
						<span class="focus-input100"></span>
					</div>
