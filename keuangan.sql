...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2023 at 12:07 PM
...
(2, 'Sarung Tangan Comet', '-', 2200000, 1),
(3, 'Washer OD 30 ID 17 T ', '2.9', 800000, 1),
(4, 'Sarung Tangan', '-', 265000, 1),
(5, 'Pipa Medium Spindo', '1.5 inchi', 36600000, 1),
(6, 'Sarung tangan', '-', 2630000, 1),
(7, 'Weco Fiq 206', '2 inchi', 9920000, 1),
(8, 'Sarung Tangan', '-', 2550000, 1),
(9, 'Sarung Tangan ', '-', 2430000, 1),
(10, 'Pipa', '-', 1385000, 1),
(11, 'Material Line Assy', '-', 49576000, 1),
(12, 'Project Part Line Assy', '-', 9245000, 1),
(13, 'Material Line Logistic', '-', 49969000, 1),
(14, 'Sarung Tangan', '-', 2420000, 1),
(15, 'Sarung Tangan', '-', 2330000, 1);
